...
- [x] Celebratory sound effects (ding, confetti pop, level up)
- [x] Smart task type detection based on keywords
...
- [ ] Build Auto-Dash feature (task suggestions to remove decision paralysis) - Deferred: needs refactoring to avoid build issues
